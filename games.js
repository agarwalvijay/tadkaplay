...
export const GAMES = [
  ...
  },
  {
    id: 'tadka',
    title: 'Tadka Tashan',
    tagline: "Tap on the beat. Don't burn it.",
    description: 'A kadhai heats up and spices drop on the beat — the whole room taps in time to keep it sizzling. Miss too many and the tadka burns! Pick your heat: Mild, Medium or Extra Spicy.',
    icon: '🍳',
    accent: '#ff7a18',
    accent2: '#e63946',
    gfx: 'pan',
    ...
    path: '/tadka/host',
    spice: 3,
    meta: ['👥 2–12', '🥁 Rhythm', '🤝 Co-op'],
  },
  {
    id: 'bhediya',
    title: 'Bhediya',
    tagline: 'One of you is the wolf.',
    description: 'Everyone gets a secret word — except the lone wolf, who must bluff. Each player gives a one-word clue, then the room votes on who the faker is. Catch the wolf, or escape with the points.',
    icon: '🐺',
    accent: '#e63946',
    accent2: '#9b5de5',
    gfx: 'wolf',
