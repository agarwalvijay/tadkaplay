...
export const GAMES = [
  ...
  {
    id: 'npac',
    title: 'Naam Place Animal Cheez',
    tagline: 'Pick a letter. Fill the blanks.',
    description: 'The desi classic! A random letter drops and everyone races to fill Name, Place, Animal & Thing starting with it. Unique answers score more than ones others wrote — and the first to finish hits STOP!',
    icon: '📝',
    accent: '#4cc9f0',
    accent2: '#06d6a0',
    gfx: 'sheet',
